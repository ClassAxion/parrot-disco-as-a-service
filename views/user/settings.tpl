    ...
    <div class="container-fluid py-4">
        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
            ...
            <form role="form" method="POST">
                <label>Your ID for flight link</label>
                <div class="form-text mb-2">
                    This ID will be used for generating your unique dashboard link like
                    <small>https://flight.parrotdisco.pl/myparrot55</small>
                </div>
                <div class="mb-3">
                    <input
                        type="text"
                        minlength="5"
                        class="form-control"
                        placeholder="For example: myparrot55"
                        name="hash"
                        required=""
                        {{if
                        .User.Hash
                ...
                <div class="mb-3">
                    <input
                        ...
                        name="zeroTierNetworkId"
                        minlength="16"
                        maxlength="16"
                        required=""
                        {{if
                        .User.ZeroTierNetworkId
                        }}value="{{.User.ZeroTierNetworkId}}"
                        {{end}}
                    />
                </div>
                <label>ZeroTier Disco IP address</label>
                <div class="mb-3">
                    <input
                        type="text"
                        class="form-control"
                        placeholder="ZeroTier Disco IP address"
                        name="zeroTierDiscoIP"
                        maxlength="15"
                        minlength="7"
                        pattern="^((\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.){3}(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])$"
                        required=""
                        {{if
                        .User.ZeroTierDiscoIP
                        }}value="{{.User.ZeroTierDiscoIP}}"
                        {{end}}
                    />
                </div>
                ...
                <div class="form-text mb-2">
                    You can use
                    <a href="https://www.calcmaps.com/map-elevation/" target="_blank">this website - calcmaps.com</a> to
                    find it out.
                </div>
                <div class="mb-3">
                    <input
                        type="text"
                        class="form-control"
                        placeholder="Home location latitude"
                        name="homeLocationLatitude"
                        {{if
                        .User.HomeLocation
                        }}value="{{.User.HomeLocation.Latitude}}"
                        {{end}}
                    />
                </div>
                <div class="mb-3">
                    <input
                        type="text"
                        class="form-control"
                        placeholder="Home location longitude"
                        name="homeLocationLongitude"
                        {{if
                        .User.HomeLocation
                        }}value="{{.User.HomeLocation.Longitude}}"
                        {{end}}
                    />
                </div>
                <div class="mb-3">
                    <input
                        type="text"
                        class="form-control"
                        placeholder="Home location altitude (in meters!)"
                        name="homeLocationAltitude"
                        min="0"
                        step="1"
                        {{if
                        .User.HomeLocation
                        }}value="{{.User.HomeLocation.Altitude}}"
                        {{end}}
                    />
                </div>
                ...
                <div class="form-text mb-2">
                    <a
                        href="https://www.google.pl/maps/search/{{.User.HomeLocation.Latitude}},{{.User.HomeLocation.Longitude}}"
                        target="_blank"
                        >Show location on Google Maps</a
                    >. You can check if you set the location correctly.
                </div>
                {{ end }}
                <div class="form-text mb-2">
                    If you will set your home location, then parrot disco will come back to that point on signal lost or
